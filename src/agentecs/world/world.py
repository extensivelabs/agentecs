...
class World:
    ...
    def get_copy(self, entity: EntityId, component_type: type[ComponentT]) -> ComponentT | None:
    ...
    def singleton_copy(self, component_type: type[ComponentT]) -> ComponentT | None:
