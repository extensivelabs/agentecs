...
Usage:
    world = World(LocalStorage(), SimpleScheduler())
...
from agentecs.functions.result import normalize_result, validate_result_access
from agentecs.models.component import Combinable, get_type
...
from agentecs.services.world.access import ScopedAccess
